...
namespace Inworld.Runtime
{
    public class CharacterChooser : MonoBehaviour
    {
        ...
        public void ChooseCurrentSet()
        {
            ...
            InworldAI.Game.CurrentWorkspace = InworldAI.User.Workspaces.Values.FirstOrDefault
                (wsData => wsData.characters.FirstOrDefault(charData => charData.brain == m_Data.brain) != null);
