...
namespace Inworld.Sample
{
    ...
    public class InworldPlayer : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("m_Canvas")][SerializeField] GameObject m_GlobalChatCanvas;
        ...
        void Update()
        {
            ...
            InworldController.IsCapturing = m_RecordButton.IsRecording || !m_GlobalChatCanvas.activeSelf;
